...
from backend.encouragemint.notifications.email import send_garden_registered_email, send_profile_created_email, \
    send_garden_location_not_found_email
from backend.encouragemint.tests.helpers import create_test_garden
...
class TestSendProfileCreatedEmail(EmailTestCase):
    def test_email_notification(self):
        ...
        send_profile_created_email(self.user_email_address, self.user_first_name)
...
class TestSendGardenLocationNotFoundEmail(EmailTestCase):
    def test_email_notification(self):
        ...
        send_garden_location_not_found_email(
            self.user_email_address, self.user_garden_name, self.user_first_name, self.user_garden_location)
