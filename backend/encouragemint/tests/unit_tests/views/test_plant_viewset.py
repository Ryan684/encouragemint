...
from backend.encouragemint import models
...
from backend.encouragemint.tests.helpers import SAMPLE_PLANT
...
class TestPost(TestCase):
    def setUp(self):
        ...
        patcher = patch("backend.encouragemint.views.plant_viewset.lookup_plants")
