...
from backend.encouragemint.tests.helpers import TREFLE_ID_LOOKUP_RESPONSE
...
class TestPlantDetailView(TestCase):
    def setUp(self):
        ...
        trefle_patcher = patch("backend.encouragemint.views.plant_detail_view.lookup_plant_by_id")
