...
from backend.encouragemint import weather
...
class TestWeather(TestCase):
    def setUp(self):
        ...
        test_responses_dir = "backend/encouragemint/tests/unit_tests/test_responses"
        ...
        patcher = patch("backend.encouragemint.weather.search_for_nearest_weather_stations")
        self.search_for_nearest_weather_stations = patcher.start()

        patcher = patch("backend.encouragemint.weather.get_station_weather_record")
