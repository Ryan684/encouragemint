# Generated by Django 2.2.7 on 2020-05-27 11:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('garden', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plants', to='backend.Garden')),
            ],
        ),
        migrations.AddField(
            model_name='garden',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gardens', to='backend.Profile'),
        ),
    ]
