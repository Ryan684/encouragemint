...
class TestMeteostat(TestCase):
    ...
    @patch("requests.post")
    def test_successful_search_for_nearest_weather_stations(self, mock_meteostat):
        mock = Mock()
    ...
    @patch("requests.post")
    def test_unsuccessful_search_for_nearest_weather_stations(self, mock_meteostat):
        mock = Mock()
    ...
    @patch("requests.post")
    def test_unsuccessful_search_for_nearest_weather_stations_from_meteostat_exception(self, mock_meteostat):
        mock_meteostat.side_effect = requests.exceptions.ConnectionError
    ...
    @patch("requests.post")
    def test_successful_get_station_weather_record(self, mock_meteostat):
        mock = Mock()
    ...
    @patch("requests.post")
    def test_unsuccessful_get_station_weather_record(self, mock_meteostat):
        mock = Mock()
    ...
    @patch("requests.post")
    def test_unsuccessful_get_station_weather_record_from_meteostat_exception(self, mock_meteostat):
        mock_meteostat.side_effect = requests.exceptions.ConnectionError
